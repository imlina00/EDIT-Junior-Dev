...
import Volunteer from '../components/Volonter';
import AddVolunteer from '../components/dodajVolontera';
import { VolunteerData } from '../interfaces';
  ...
  return (
    <div className="volonteri">
      ...
      <div className='volunteerWrapper'>
        ...
        <h3 className='titleSecond'>Grad:</h3>
          ...
          <h3 className='titleSecond'>Uloge:</h3>
